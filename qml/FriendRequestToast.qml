...
Rectangle {
    ...
    signal accepted(string pseudo)
    signal rejected(string pseudo)
    ...
    Row {
        ...
        Text {
            text: toast.fromPseudo + " vous demande en ami"
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: {
                    toast.accepted(toast.fromPseudo)
                    toast.hide()
                    autoHideTimer.stop()
                }
            }
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                cursorShape: Qt.PointingHandCursor
                onClicked: {
                    toast.rejected(toast.fromPseudo)
                    toast.hide()
                    autoHideTimer.stop()
                }
            }
