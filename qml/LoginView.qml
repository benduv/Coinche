        ...
        Component {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    Column {
                        Layout.fillWidth: true
                        spacing: loginRoot.isPortrait ? 8 * loginRoot.minRatio : 6 * loginRoot.minRatio
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            if (newPassword.text.length < 8) {
                                changePasswordError.text = "Le mot de passe doit contenir au moins 8 caractères"
                                return
                            }
