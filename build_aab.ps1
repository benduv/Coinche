...
# Modifier build.gradle pour forcer les deux architectures
...
(Get-Content $buildGradle) -replace 'abiFilters qtTargetAbiList\.split\(","\)', 'abiFilters "arm64-v8a", "armeabi-v7a"' | Set-Content $buildGradle
